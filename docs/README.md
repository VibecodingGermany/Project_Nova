...
**Version:** 0.3.0 | **Status:** Living Document | **Verantwortungsbereich:** Executive Producer / Technical Writer | **Sprint:** 2
...
Dieses Wiki folgt dem Prinzip vieler kleiner, logisch getrennter und untereinander verlinkter Markdown-Dokumente statt weniger Monolithen. Regeln siehe [meta/DocumentationStandard.md](meta/DocumentationStandard.md).
...
| Technical Design | tech/ | bereit (GO) | 3 |
| Architecture Review | tech/review/ | geplant | 4 |
...
### Vision (Sprint 2)
- [Vision.md](vision/Vision.md) – Leitbild, Design-Säulen, Anti-Ziele
- [USP.md](vision/USP.md) – Alleinstellungsmerkmale (Kern-USP: lebendiges Aetherium)
- [TargetAudience.md](vision/TargetAudience.md) – Personas H1–H4, Nicht-Zielgruppen
- [CoreGameplay.md](vision/CoreGameplay.md) – Spielgefühl, Kamera, Steuerung, UI-Prinzipien
- [GameLoop.md](vision/GameLoop.md) – Kernloop, Match-Phasen, Anti-Stall
...
- [DecisionLog.md](production/DecisionLog.md) – alle Entscheidungen (D-001–D-032)
- [OpenQuestions.md](production/OpenQuestions.md) – offene Fragen (Q-013–Q-015, Q-018–Q-020)
- [RiskAnalysis.md](production/RiskAnalysis.md) – Risikoregister
- Sprint-Berichte: [Sprint 0](production/sprints/Sprint00_Report.md) · [Sprint 1](production/sprints/Sprint01_Report.md) · [Sprint 2](production/sprints/Sprint02_Report.md)
...
- Verbindlicher Technik-Stack: Unity 6.3 LTS, C#, URP ([DecisionLog D-006](production/DecisionLog.md)).
...
- Q-013–Q-015 (Sim-/MP-Modell, Pathfinding, ECS/DOTS) und Q-020 (Headless-KI-Runner): Entscheidung in Sprint 3.
- Q-018 (Preis), Q-019 (Telemetrie): Sprint 6 bzw. 3/6.

## Nächste Schritte

- Sprint 3 (Technical Design) starten: Architektur-Entscheidungen D-033 ff., TDD-Dokumente gemäß [Sprint02_Report.md](production/sprints/Sprint02_Report.md) §8.
