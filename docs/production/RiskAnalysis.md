...
**Version:** 1.2.0 | **Status:** aktiv (laufend) | **Verantwortungsbereich:** Executive Producer / Lead Technical Director | **Sprint:** 2
...
| R-02 | Multiplayer-Architektur zu spät entschieden | mittel | hoch | TPD sagt "MP erst nach Singleplayer-Kern" – aber Simulationsmodell (Q-013) und Determinismus-Anforderung müssen **vor** dem Gameplay-Code stehen, sonst teurer Rewrite. | Entscheidung Q-013 spätestens Sprint 3; Simulation von Anfang an determinismusfähig strukturieren; Research Sprint 1 | aktiv |
| R-03 | Pathfinding skaliert nicht | mittel | hoch | 100–500+ Einheiten, Formationen, dynamische Hindernisse (zerstörbare Umgebung!) überfordern naive Lösungen; größtes Risiko laut TPD Phase 0. | Research Sprint 1 (Q-014); Performance-Spike in TPD Phase 0 mit echten Zahlen; Budgets in Sprint 3 | aktiv |
...
- Keine Risiken aktuell eskaliert. R-01 nach Scope-Bezifferung (Sprint 2) von hoch/hoch auf mittel/hoch gesenkt; R-05 entschärft (D-012).
- R-02: Fortschritt – Simulationsarchitektur-Regeln aus Research vorhanden; Restrisiko hängt an Sprint-3-Entscheidung Q-013 und Phase-0-Determinismus-Spike.
- R-03: Fortschritt – Flow-Field+ORCA-Ansatz als Vorlage; Restrisiko hängt an Phase-0-Budget-Messung.
- Neuer Beobachtungspunkt (kein eigenes Risiko): Kristallsturm-Aetherium-Kopplung (D-027.1) – Balancing-Beobachtungspflicht im Balancing-Pass v0.2.

## Nächste Schritte

- Update am Ende von Sprint 3 (Architektur-Entscheidungen wirken auf R-02, R-03, R-08, R-11).
